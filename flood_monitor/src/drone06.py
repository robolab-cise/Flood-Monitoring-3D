...
class Follower:
    ...
    def callback(self, data):
        ...
        if d06_posZ < 2 and dist_56 > 15:            
            ...
            if d06_posZ >= 2 and curr_time > 10:
                ...
                if dist_67 <= MAX_DIST  and d07_posZ >= 2:
                    #print("[drone06] d67 REPUL APPEAR!!", dist_67)
        ...
        #print('[drone06] position control now')
        rospy.Rate(1).sleep
